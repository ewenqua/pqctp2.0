...
class ReqUserLoginField(Base):
    ...
    def __init__(self,TradingDay='',BrokerID='',UserID='',Password='',UserProductInfo='',InterfaceProductInfo='',ProtocolInfo='',MacAddress='',OneTimePassword='',ClientIPAddress='',LoginRemark='',ClientIPPort=0):
...
class ExchangeExecOrderActionField(Base):
    ...
    def __init__(self,ExchangeID='',ExecOrderSysID='',ActionFlag='',ActionDate='',ActionTime='',TraderID='',InstallID=0,ExecOrderLocalID='',ActionLocalID='',ParticipantID='',ClientID='',BusinessUnit='',OrderActionStatus='',UserID='',ActionType='',BranchID='',IPAddress='',MacAddress='',ExchangeInstID='',Volume=0):
...
class ExchangeOptionSelfCloseActionField(Base):
    ...
    def __init__(self,ExchangeID='',OptionSelfCloseSysID='',ActionFlag='',ActionDate='',ActionTime='',TraderID='',InstallID=0,OptionSelfCloseLocalID='',ActionLocalID='',ParticipantID='',ClientID='',BusinessUnit='',OrderActionStatus='',UserID='',BranchID='',IPAddress='',MacAddress='',ExchangeInstID='',OptSelfCloseFlag=''):
