...
if sys.platform == 'win32':
    from ctp_win64.ctpwrapper.TraderApi import TraderApiWrapper
    from ctp_win64.ctpwrapper import ApiStructure
elif sys.platform == 'linux':
    from ctp_linux64.ctpwrapper.TraderApi import TraderApiWrapper
    from ctp_linux64.ctpwrapper import ApiStructure

class TraderApiPy(TraderApiWrapper):
    def __init__(self, broker_id='', investor_id='', passwd='', auth_code='', app_id='', *args,**kwargs):
        self.requestid=30
    ...
    def OnFrontConnected(self):
        ...
        req = ApiStructure.ReqAuthenticateField(BrokerID=self.broker_id, UserID=self.investor_id, AuthCode=self.auth_code, AppID=self.app_id)
   ...
   # 投资者结算结果确认响应
    ...
    def OnRtnTrade(self, pTrade):
        ...
        DatabaseController.insert_RtnOrder(pTrade.to_dict()) # dict will change bytes to str
